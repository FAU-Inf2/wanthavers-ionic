wanthaver.constant('CloudMessageSubject', {
   ...
   'HAVERUNACCEPTED': 'HaverUnaccepted',
   'HAVERUNACCEPTED_DESIREID': this.DESIRECOMPLETE_DESIREID,
   'HAVERUNACCEPTED_DESIRETITLE': this.DESIRECOMPLETE_DESIRETITLE,

   'WANTERUNACCEPTED': "WanterUnaccepted",
   'WANTERUNACCEPTED_DESIREID': this.DESIRECOMPLETE_DESIREID,
   'WANTERUNACCEPTED_DESIRETITLE': this.DESIRECOMPLETE_DESIRETITLE,
});
